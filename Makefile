...
reports/final_shark_report.pdf: shark_report.Rmd figures/shark_sex_fatality.png figures/shark_type_fatality.png
	R -e "rmarkdown::render('shark_report.Rmd', output_format='pdf_document', output_file='reports/final_shark_report.pdf')"